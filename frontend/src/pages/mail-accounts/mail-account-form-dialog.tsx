...
export function MailAccountFormDialog({
  ...
  return (
    <AppDialog
      ...
      title={editingAccount ? "Edit Mail Account" : "Add Mail Account"}
      description={
        editingAccount
      ...
      onCancel={onClose}
      cancelLabel="Cancel"
      primaryLabel={editingAccount ? "Save Changes" : "Create Account"}
      primaryIcon={<Save />}
      loading={isMutating}
      form="mail-account-form"
    >
      <form id="mail-account-form" onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
        {/* Name */}
