...
class TestProcessMailStatusTransitions:
    ...
    async def test_successful_pipeline_marks_completed(self):
        ...
        with (
            ...
            patch(
                ...
                return_value=MagicMock(raw_bytes=b"raw email bytes", imap_folders=["INBOX", "Sent"], folder_separator="/", relocated=False, new_folder=None, new_uid=None),
            ),
            patch(
    ...
    async def test_parse_error_sets_error_type_mail(self):
        ...
        with (
            ...
            patch(
                "app.workers.mail_processor.fetch_raw_mail",
                return_value=MagicMock(raw_bytes=b"raw email bytes", imap_folders=["INBOX"], folder_separator="/", relocated=False, new_folder=None, new_uid=None),
            ),
            patch(
                "app.workers.mail_processor.parse_raw_mail",
