...
async def startup(ctx: dict[str, Any]) -> None:
    ...
    async def _on_reactivation(event: Any) -> None:
...
async def sync_contacts(ctx: dict[str, Any]) -> None:
...
async def cleanup_drafts(ctx: dict[str, Any]) -> None:
...
async def recover_paused(ctx: dict[str, Any]) -> None:
