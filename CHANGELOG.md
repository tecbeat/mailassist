...
- *(deps)* Update gitlab-ci - ([3099389](https://git.teccave.de/tecbeat/mailassist/commit/309938998200acaa7a176447c92f3e3f5c7de5ff))
...
- *(deps)* Update all non-major dependencies - ([418229d](https://git.teccave.de/tecbeat/mailassist/commit/418229d7ce6d5532e6dc024ef7893fbf0f9a2f4f))
- *(deps)* Update python:3.14-slim docker digest to cae66f2 - ([e571515](https://git.teccave.de/tecbeat/mailassist/commit/e57151529d840f3ba6e0a9d375e5d0ded0eef2f6))
- *(deps)* Update node.js to e67514e - ([13cb365](https://git.teccave.de/tecbeat/mailassist/commit/13cb3658b8baf5b27f1f6b1df92a1d5c2f360ddc))

## [2.21.2-beta](https://git.teccave.de/tecbeat/mailassist/-/releases/v2.21.2-beta) - 2026-08-26
...
- *(deps)* Update gitlab-ci - ([77266f0](https://git.teccave.de/tecbeat/mailassist/commit/77266f0a27cdf63145c9fb1cb96e5db8cd95eb9c))

## [2.21.1-beta](https://git.teccave.de/tecbeat/mailassist/-/releases/v2.21.1-beta) - 2026-08-25

### 🐛 Bug Fixes

- *(deps)* Update all non-major dependencies - ([6bdd77d](https://git.teccave.de/tecbeat/mailassist/commit/6bdd77d769ecc1b9bb3b16de7f878005345f46df))
...
- *(deps)* Update all non-major dependencies - ([a05b46c](https://git.teccave.de/tecbeat/mailassist/commit/a05b46c9281bdaf12948fdd3120ea138ee101aff))
...
- *(deps)* Update postgres:18-alpine docker digest to fa206fb - ([b347776](https://git.teccave.de/tecbeat/mailassist/commit/b347776c56ac4bd7440f481772045ced40e1206f))

### ⚙️ Miscellaneous Tasks

- *(deps)* Update postgres:18-alpine Docker digest to fa206fb - ([258bb9c](https://git.teccave.de/tecbeat/mailassist/commit/258bb9c53e30f2d61a4cfa9538adf484c797c106))

## [2.20.6-beta](https://git.teccave.de/tecbeat/mailassist/-/releases/v2.20.6-beta) - 2026-05-15

## [2.20.5-beta](https://git.teccave.de/tecbeat/mailassist/-/releases/v2.20.5-beta) - 2026-05-15
...
- *(deps)* Update postgres:18-alpine docker digest to fbe586b - ([d1a1547](https://git.teccave.de/tecbeat/mailassist/commit/d1a15471d45b48d04e2e14ef971119ec5d37d435))
...
- *(deps)* Update all non-major dependencies - ([08e2e00](https://git.teccave.de/tecbeat/mailassist/commit/08e2e000013c811b1b242ba52cd154207c4a01cb))
...
- *(deps)* Update python:3.14-slim docker digest to 1697e8e - ([438602e](https://git.teccave.de/tecbeat/mailassist/commit/438602e1059af555c2a9245b7bef75da6b401923))

### ⚙️ Miscellaneous Tasks

- *(deps)* Update gitlab-ci - ([9d63089](https://git.teccave.de/tecbeat/mailassist/commit/9d63089cca41ec3bb144ddb08400630cedb2e35e))

## [2.18.4-beta](https://git.teccave.de/tecbeat/mailassist/-/releases/v2.18.4-beta) - 2026-05-09

### 🐛 Bug Fixes

- *(deps)* Update python:3.14-slim docker digest to aee3b1c - ([183ddc1](https://git.teccave.de/tecbeat/mailassist/commit/183ddc15ea8853704932e8a5aee86c044d867867))

## [2.18.3-beta](https://git.teccave.de/tecbeat/mailassist/-/releases/v2.18.3-beta) - 2026-05-09

### 🐛 Bug Fixes

- *(deps)* Update ghcr.io/astral-sh/uv docker tag to v0.11.12 - ([847ddc4](https://git.teccave.de/tecbeat/mailassist/commit/847ddc456c2de2c3706a9be03672ee502b365c3b))

### ⚙️ Miscellaneous Tasks

- *(deps)* Update gitlab-ci - ([5335e6f](https://git.teccave.de/tecbeat/mailassist/commit/5335e6f1556fbcc5071c9f052769358a7a8c1e13))
...
- Use dynamic height for contact card and add empty state icon to summaries - ([0195cb7](https://git.teccave.de/tecbeat/mailassist/commit/0195cb747d25d3a2c753a87465edfa9dab1cc78f))
- Replace scroll areas with pagination in contact matching card - ([50df4fe](https://git.teccave.de/tecbeat/mailassist/commit/50df4fe2bdfb2596cba181836d8e92ba7849b64f))
...
- *(deps)* Update dependency @types/node to v25.6.2 - ([94248db](https://git.teccave.de/tecbeat/mailassist/commit/94248dbd15075c35b12ba9bd0af853c23123e750))
- *(deps)* Update all non-major dependencies - ([2b82e44](https://git.teccave.de/tecbeat/mailassist/commit/2b82e440bd7edf05b2b1da0dd82b673e179eedb5))
...
- *(deps)* Update valkey/valkey:9-alpine docker digest to d1cc706 - ([6229c14](https://git.teccave.de/tecbeat/mailassist/commit/6229c143f767dfdd90a2f6ffe7eb2a2eca353280))
...
## [0.6.0-beta](https://git.teccave.de/tecbeat/mailassist/-/releases/v0.6.0-beta) - 2026-04-30
